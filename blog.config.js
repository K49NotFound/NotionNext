...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Wyy&Xzj', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '王又幼和谢中骏的网站记录', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wwyyxzjlove.us', // 网站地址
